...
class QqBitApplicationTests {
    ...
    void test() {
        ...
        Set<String> set = mdCacheService.getMdCache("mdDic", "KeyWord").keySet();
        for (String o : set) {
            System.out.println(o);
        }      Set<String> keywords = mdCacheService.getMdCache("mdDic", "KeyWord").keySet();
    ...
    void contextLoads() {
        FastAutoGenerator.create(dataSourceProperties.getUrl(), dataSourceProperties.getUsername(), dataSourceProperties.getPassword())
                ...
                .packageConfig(builder -> {
                    builder.parent("com.jky.qqbot") // 设置父包名
                            .moduleName("") // 设置父包模块名
